...
!(function (o) {
    ...
    (t.prototype.initCustomSelect = function () {
        ...
        (t.prototype.initFlatpickr = function () {
                ...
                o("#basic-datepicker2").flatpickr(),
                o("#datetime-datepicker").flatpickr({ enableTime: !0, dateFormat: "Y-m-d H:i" }),
                o("#humanfd-datepicker").flatpickr({ altInput: !0, altFormat: "F j, Y", dateFormat: "Y-m-d" }),
                ...
                o("#multiple-datepicker").flatpickr({ mode: "multiple", dateFormat: "Y-m-d" }),
                o("#conjunction-datepicker").flatpickr({ mode: "multiple", dateFormat: "Y-m-d", conjunction: " :: " }),
                o("#range-datepicker").flatpickr({ mode: "range" }),
                o("#range-datepicker2").flatpickr({ mode: "range" }),
        ...
        (t.prototype.initColorpicker = function () {
            o("#basic-colorpicker").colorpicker(),
                ...
                o("#inline-colorpicker").colorpicker({ color: "#DD0F20", inline: !0, container: !0 });
        }),
